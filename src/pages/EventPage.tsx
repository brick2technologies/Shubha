    ...
    <div className="font-sans bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl">
          ...
          >
            <motion.h1 
              className="text-7xl md:text-8xl font-black mb-6 text-white drop-shadow-2xl font-playfair"
              animate={{ 
                textShadow: [
            ...
            <p className="text-2xl md:text-3xl mb-12 text-white font-light tracking-wide font-Inter">
      ...
      offset={-100}      // Optional: adjust for fixed headers
      className="inline-block mb-20"
    >
      <motion.button
        whileHover={{ scale: 1.1, rotate: 2 }}
        whileTap={{ scale: 0.95 }}
        className="bg-white text-[#FF4500] px-12 py-5 rounded-full text-xl font-bold shadow-2xl hover:shadow-[#FF9933]/50 transition-all cursor-pointer font-Inter"
      >
        Start Your Journey
      </motion.button>
    </ScrollLink>
      ...
      <section id="categories" className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 font-Inter">Choose your event category</p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16">
            {categories.map((cat) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`px-8 py-4 rounded-full font-bold font-Inter text-lg transition-all ${
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {eventCategories[activeCategory as keyof typeof eventCategories].map((event, idx) => (
                ...
                >
                  <div className="relative h-80 rounded-3xl overflow-hidden shadow-2xl font-Inter">
                    <img
                      src={event.image}
                      alt={event.title}
                    ...
                    {/* Icon Badge */}
                    <div className="absolute top-6 right-6 w-16 h-16 bg-white rounded-full flex items-center justify-center text-3xl shadow-xl">
                      {event.icon}
                    </div>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                      ...
                      <motion.div
                        ...
                        className="inline-flex items-center text-[#FFD700] font-semibold"
                      >
                        Learn More →
                      </motion.div>
                    </div>
      ...
      {/* Stats Section */}
      <section className="py-24 bg-gradient-to-r from-[#FF9933] to-[#FF4500] text-white font-Inter">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: idx * 0.1 }}
              >
                <div className="text-6xl font-black mb-2">{stat.number}</div>
                <div className="text-xl font-light">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
    ...
    <div className="grid md:grid-cols-3 gap-8 font-Inter">
      {testimonials.map((testimonial, idx) => (
        <motion.div
          ...
          className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-3xl shadow-xl border-2 border-[#FF9933]/20 relative"
        >
          <div className="absolute -top-6 -left-6 w-16 h-16 bg-gradient-to-br from-[#FF9933] to-[#FF4500] rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-xl">
            "
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-gradient-to-br from-[#FF9933] to-[#FF4500] rounded-full flex items-center justify-center text-white font-bold text-xl">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-7xl font-black text-white mb-6 font-playfair">
              LET'S CREATE
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center font-Inter">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-[#FF9933] to-[#FF4500] text-white px-12 py-5 rounded-full text-xl font-bold shadow-2xl hover:shadow-[#FF9933]/50"
              >
                Book Consultation
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white/10 backdrop-blur-md text-white px-12 py-5 rounded-full text-xl font-bold border-2 border-white/30 hover:bg-white/20"
              >
                View Portfolio
              </motion.button>
            </div>
