...
type AboutUsProps = {
  onNavigate: (page: "home" | "categories" | "about" | "search" | "cart", category?: string, query?: string) => void;
};


const AboutUs: React.FC<AboutUsProps> = ({ onNavigate }) => {
  return (
    <section className="relative bg-gradient-to-b from-cream via-white to-cream py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-saffron font-playfair">
